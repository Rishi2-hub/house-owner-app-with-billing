...
def upsert_bill(data):
    ...
    db_client.collection("bills").document(doc_id).set({
        ...
        "billing_type": data.get("billing_type", "Full month"),
        "billing_start_day": data.get("billing_start_day", 1),
        "billing_end_day": data.get("billing_end_day"),
        "billable_days": data.get("billable_days"),
        "bs_month_days": data.get("bs_month_days"),
        "rent_amount": data.get("rent_amount", 0),
